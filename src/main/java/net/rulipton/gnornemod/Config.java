...
@Mod.EventBusSubscriber(modid = GnorneMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config
{
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> BLOCK_STRINGS = BUILDER
            .comment("A list of blocks to log on common setup.")
            .defineListAllowEmpty("blocks", List.of("minecraft:iron_block"), Config::validateBlockName);
